...
export interface ApiAdvisoryJuryAdvisoryJury
  extends Struct.CollectionTypeSchema {
  collectionName: 'advisory_juries';
  info: {
    displayName: 'Advisory jury';
    pluralName: 'advisory-juries';
    singularName: 'advisory-jury';
  };
  options: {
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    article_excerpt: Schema.Attribute.Text & Schema.Attribute.Required;
    article_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    article_title: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    author_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
...
export interface ApiEfficacyAssessmentEfficacyAssessment
  extends Struct.CollectionTypeSchema {
  collectionName: 'efficacy_assessments';
  info: {
    displayName: 'Efficacy Assessment';
    pluralName: 'efficacy-assessments';
    singularName: 'efficacy-assessment';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiEfficacyEvaluationQuestionEfficacyEvaluationQuestion
  extends Struct.SingleTypeSchema {
  collectionName: 'efficacy_evaluation_questions';
  info: {
    displayName: 'Efficacy evaluation question';
    pluralName: 'efficacy-evaluation-questions';
    singularName: 'efficacy-evaluation-question';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMagazineLikeMagazineLike
  ...
  info: {
    displayName: 'Magazine Like';
    pluralName: 'magazine-likes';
    singularName: 'magazine-like';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMainMagazineMainMagazine
  extends Struct.CollectionTypeSchema {
  collectionName: 'main_magazines';
  info: {
    displayName: 'Main Magazine';
    pluralName: 'main-magazines';
    singularName: 'main-magazine';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    hero_img: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    magazine_cover: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    magazine_like: Schema.Attribute.Relation<
      'oneToOne',
      'api::magazine-like.magazine-like'
    >;
...
export interface ApiMiranEvidenceMiranEvidence
  extends Struct.CollectionTypeSchema {
  collectionName: 'miran_evidences';
  info: {
    displayName: 'Miran Evidence';
    pluralName: 'miran-evidences';
    singularName: 'miran-evidence';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiMiranToolMiranTool extends Struct.CollectionTypeSchema {
  collectionName: 'miran_tools';
  info: {
    displayName: 'Miran Tool';
    pluralName: 'miran-tools';
    singularName: 'miran-tool';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiUserBookMarkUserBookMark
  extends Struct.CollectionTypeSchema {
  collectionName: 'user_book_marks';
  info: {
    displayName: 'User BookMark';
    pluralName: 'user-book-marks';
    singularName: 'user-book-mark';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    bookmarks: Schema.Attribute.Component<
      'book-marks.user-book-marks-componenet',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiUserProfileUserProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    basic_info: Schema.Attribute.JSON;
    contact_information: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiWebinarWebinar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    webinar_date: Schema.Attribute.DateTime;
  };
}
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    efficacy_assessment: Schema.Attribute.Relation<
      'oneToOne',
      'api::efficacy-assessment.efficacy-assessment'
    >;
    email: Schema.Attribute.Email &
    ...
    > &
      Schema.Attribute.Private;
    lockoutUntil: Schema.Attribute.DateTime;
    loginAttempts: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    magazine_likes: Schema.Attribute.Relation<
      'manyToMany',
      'api::magazine-like.magazine-like'
    >;
    password: Schema.Attribute.Password &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user_book_marks: Schema.Attribute.Relation<
      'oneToMany',
      'api::user-book-mark.user-book-mark'
    >;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::advisory-jury.advisory-jury': ApiAdvisoryJuryAdvisoryJury;
